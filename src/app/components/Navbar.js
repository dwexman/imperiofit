...
const WHATSAPP_URL =
  "https://wa.me/56973797211?text=Hola%20Imperio%20Fit%2C%20quiero%20m%C3%A1s%20informaci%C3%B3n.";
      ...
      <nav className="relative flex w-full items-center justify-between px-4 py-2 lg:px-6">
        ...
        <div className="hidden md:block">
          <a
            ...
            aria-label="Inscribirse en Imperio Fit por WhatsApp"
