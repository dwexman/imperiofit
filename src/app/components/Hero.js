...
export default function Hero() {
    return (
        <section
            id="inicio"
            className="relative min-h-[118vh] overflow-hidden bg-black px-5 pb-24 pt-[38vh] md:min-h-[112vh] md:pb-28 md:pt-[34vh] lg:px-8 lg:pt-[32vh]"
        >
            {/* Video de fondo */}
            <video
            ...
            {/* Glow fuego inferior */}
            <div className="absolute bottom-0 left-1/2 h-[480px] w-[480px] -translate-x-1/2 rounded-full bg-[#FF5A1F]/20 blur-[130px]" />
            ...
            <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center text-center">
                <Image
                    ...
                    height={220}
                    priority
                    className="mb-5 h-auto w-[210px] opacity-90 md:w-[300px] lg:w-[350px]"
                />
